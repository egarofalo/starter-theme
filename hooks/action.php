...
use function CoDevelopers\StarterTheme\Helpers\Asset\admin_login_styles;
use function CoDevelopers\StarterTheme\Helpers\Asset\asset;
use function CoDevelopers\StarterTheme\Helpers\Asset\scripts;
use function CoDevelopers\StarterTheme\Helpers\Asset\shared_script;
use function CoDevelopers\StarterTheme\Helpers\Asset\styles;
...
add_action('after_setup_theme', function () {
    $navMenus = [
        ...
        'primary_navigation_mobile' => __('Primary navigation for mobile devices', 'starter-theme'),
    ];
 ...
 */
add_action('cdst_static_sidebar_content', function () {
